<template>
	<view
		...
		<view
			...
			<view class="btn-wrapper safe-area-inset-bottom" v-if="outFoStock || mode == 4">
				<view class="sure" style="color: #ffffff; background-color: #cccccc">{{ noStockText }}</view>
			</view>
			<view class="btn-wrapper safe-area-inset-bottom" v-else-if="mode == 1">
				<view
					class="sure add-cart"
			...
			<view class="btn-wrapper safe-area-inset-bottom" v-else-if="mode == 2">
				<view
					class="sure add-cart"
					:style="{
						color: themeColorFn('addCartColor'),
			...
			<view class="btn-wrapper safe-area-inset-bottom" v-else-if="mode == 3">
				<view
					class="sure"
					:style="{
						color: themeColorFn('buyNowColor'),
